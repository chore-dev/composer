...
export const askTechnicalStackDirectionQuestions = () => section('Technical Stack Direction', async () => {
...
export type TECHNICAL_STACK_DIRECTION_ANSWERS = Prettify<ENV_ANSWER & FRAMEWORK_ANSWER & PACKAGE_MANAGER_ANSWER & STYLE_SHEET_ANSWER & SYNTAX_EXTENSION_ANSWER>
