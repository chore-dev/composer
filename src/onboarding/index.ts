...
export const askOnBoardingQuestions = () => section('Onboarding Questions', async () => {
...
export type ONBOARDING_ANSWERS = Prettify<ENV_ANSWER & FRAMEWORK_ANSWER & PACKAGE_MANAGER_ANSWER & STYLE_SHEET_ANSWER & SYNTAX_EXTENSION_ANSWER>
